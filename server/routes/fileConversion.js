...
import { convertMarkdownTextToDocx, convertMdToDocx, batchConvert, uploadFiles } from '../controllers/fileConversionController.js';

const router = express.Router();

// API: Convert Markdown to DOCX
router.post('/md-to-docx', upload.single('file'), convertMdToDocx);
router.post('/md-to-docx/text', convertMarkdownTextToDocx);
