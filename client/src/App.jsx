...
const MetaTagPreview = lazy(() => import('./pages/tools/MetaTagPreview'));
const TextCaseTool = lazy(() => import('./pages/tools/TextCaseTool'));
const WordCounterTool = lazy(() => import('./pages/tools/WordCounterTool'));
          ...
          <Layout>
            <Suspense fallback={<LoadingSpinner message="Loading page..." />}>
              <Routes>
                ...
                <Route path="/tools/meta-tag-preview" element={<MetaTagPreview />} />
